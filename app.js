...
app.use(function (err, req, res, next) {
    ...
    res.locals.error = req.app.get('env') === 'development' ? err : {status:err.status||500, message:err.message||'Sorry, an error occurred while performing the requested operation. Please try again later.'};
